...
* 友盟数据统计SDK
    ...
    SDK个人信息字段：唯一设备识别码（IDFV/OPENUDID/GUID、SIM 卡 IMSI 信息）以提供统计分析服务，并通过地理位置校准报表数据准确性，提供基础反作弊能力。
...
* 腾讯Bugly 
    ...
    SDK使用个人信息字段：日志信息（包括：第三方开发者自定义日志、Logcat 日志以及 APP 崩溃堆栈信息）、设备 ID（IDFV）、联网信息、系统名称、系统版本以及国家码。
